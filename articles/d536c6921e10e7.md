---
title: "補完、IME で Deno KV を使ってみた感想"
emoji: "🐈"
...
最近 Open Beta になった Deno KV (SQLite ベースのキーバリューストア) を使ってみたので、嵌った点や感想を書いていこうと思います。
まだ安定化していないので、この記事の内容を参考にするときは更新日時に注意してください。
...
Trie 木の方が 1 桁以上早いですが、Deno KV も十分実用的な速度ですね。
